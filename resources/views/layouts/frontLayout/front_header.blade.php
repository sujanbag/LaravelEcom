                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +91 6291227001</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> sujancolab@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{url('/')}}"><img style="width:50px;" src="{{url('theme-assets/images/logo/bblog.png')}}" alt="" /></a>
                    </div>
